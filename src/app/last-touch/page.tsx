...
function buildData() {
  ...
  const channelCards = CHANNEL_KEYS.map((ch) => ({
    ...
    pipelineShare: totalPipeline > 0 ? lt[ch].pipeline / totalPipeline : 0,
    revenue: lt[ch].revenue,
    opps: lt[ch].opps,
  }));
  ...
  const accountTable = DATA.map((acc) => {
    ...
    return {
      ...
      deal: acc.deal,
      ltChannelName: ltChannel ? CHANNELS[ltChannel].name : "N/A",
      ltChannelColor: ltChannel ? CHANNELS[ltChannel].color : "#666",
    };
  });
    ...
    >
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Last-touch attribution gives 100% credit to the final marketing
          interaction before conversion. This model highlights which channels
          are most effective at closing deals and driving the final conversion action.
        </p>
      </div>
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-base font-semibold">
            Channels Ranked by Pipeline (Last Touch)
          </CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-base font-semibold">
            All Accounts — Last Touch Channel
          </CardTitle>
        </CardHeader>
        <CardContent>
                    ...
                    <td className="py-2.5">
                      <div className="flex items-center gap-2">
                        <span
                          ...
                          style={{ backgroundColor: acc.ltChannelColor }}
                        />

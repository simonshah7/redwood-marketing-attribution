    ...
    return [
      {
        ...
        why: "73% of LinkedIn-sourced leads receive no follow-up within 14 days. They visit acmecloud.io via the ad, browse 1-2 pages, and go cold.",
        doThis: "Create a HubSpot trigger: when a lead has a LinkedIn UTM first touch, auto-enroll in \"CWP Cloud Migration\" nurture within 48 hours. Set up BDR outbound for accounts with 2+ LinkedIn engagements.",
      ...
      },
      {
        ...
        title: "HubSpot Email Severely Underinvested",
        ...
        why: "Email nurtures consistently appear in the middle of winning journeys but are invisible to first/last-touch. HubSpot is the hidden workhorse.",
        doThis: "Increase HubSpot investment by 20-30%. Build channel-specific nurture paths for LinkedIn-sourced and event-sourced leads.",
      ...
      },
      {
        ...
        title: "KubeCon Follow-Up Playbook Works",
        what: "Accounts that attended KubeCon events and then received follow-up email nurtures show the highest conversion rates.",
